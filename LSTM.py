...
class LSTMModel(nn.Module):
    ...
    """
    def __init__(self, vocab_size=129892, output_size=1, embedding_dim=400,\
        hidden_dim=256, n_layers=2, pretrain=False,embedding_matrix=0, input_len=200):
        """
